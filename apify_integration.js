...
const APIFY_TOKEN = process.env.APIFY_TOKEN || "apify_api_Apav3Cav8uBjwcm9bGrZfCV6OU3g0h0r3UmG";
...
async function searchEbay(query) {
    ...
    const url = "https://api.apify.com/v2/acts/ivanvs~ebay-scraper-ppr/run-sync";
...
async function searchAll(query) {
    ...
    const allResults = [...craigslistResults, ...fbResults, ...ebayResults];
